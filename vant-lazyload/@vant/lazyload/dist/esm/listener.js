...
var ReactiveListener = /*#__PURE__*/ (function () {
  ...
  _proto.initState = function initState() {
    //将图片的真实路径绑定到元素的data-src属性上，
    //并为监听对象添加error、loaded、rendered状态
  ...
  _proto.load = function load(onFinish) {
    ...
    // 这个函数是渲染loading图片得 渲染loading得时候执行回调
    this.renderLoading(function () {
      _this3.attempt++; // 记录尝试次数
      // 适配器？
      _this3.options.adapter.beforeLoad == null
        ? void 0
...
export { ReactiveListener as default };
